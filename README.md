...
|--------------|-------------------|---------------------------------------------|
| **latest**   | **26.5.3**        | Latest stable release of Keycloak           |
| latest-26.5  | 26.5.3            | Latest release within Keycloak version 26.5 |
| latest-26.4  | 26.4.7            | Latest release within Keycloak version 26.4 |
