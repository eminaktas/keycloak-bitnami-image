...
|--------------|-------------------|---------------------------------------------|
| **latest**   | **26.4.1**        | Latest stable release of Keycloak           |
| latest-26.2  | 26.2.10            | Latest release within Keycloak version 26.2 |
| latest-26.0  | 26.0.16           | Latest release within Keycloak version 26.0 |
