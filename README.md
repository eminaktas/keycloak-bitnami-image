...
|------------------------ |-------------------|---------------------------------------------|
| **latest, latest-26.6** | **26.6.2**        | Latest stable release of Keycloak           |
| latest-26.4             | 26.4.12           | Latest release within Keycloak version 26.4 |
| latest-26.2             | 26.2.16           | Latest release within Keycloak version 26.2 |
